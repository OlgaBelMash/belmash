 ...
 */
 (function($){
	$.fn.snowit = function(options) {
		var $flake = $('<div class="lis-flake" />').css({'position':'absolute','z-index': '9999999 !important'}).html('&#10052;'),
